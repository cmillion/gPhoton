...
Using our gPhoton pipeline, we have searched for flares from the CR Dra system using GALEX data spanning the lifetime of thie mission.  The example calls to the gPhoton methods shown here assume you've imported them as modules inside a Python script.  Our first step is to search the entire database to determine how much data is available using \texttt{gfind}:

\begin{verbatim}
data = gfind(band='NUV', skypos=[244.27246917, 55.26919386])
\end{verbatim}
...
\begin{verbatim}
gmap(band='NUV', skypos=[244.27246917, 55.26919386], stepsz=10.,
...
\begin{verbatim}
lc_data = gaperture(band='NUV', skypos=[244.27247, 55.268069],
