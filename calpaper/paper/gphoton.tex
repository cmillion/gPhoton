...
\address[ucolorado]{Laboratory for Atmospheric and Space Physics, Boulder, Colorado,  80309}
...
As a test of the relative photometric precision from gPhoton, we plot the difference between the MCAT magnitude and gAperture magnitude against the MCAT magnitude for 7692 and 20213 randomly selected MCAT sources in FUV and NUV respectively. Fig. \ref{fuvrelphot} and Fig. \ref{nuvrelphot} use the background estimated from the gAperture background annulus, while Fig. \ref{fuvrelphotmcat} and Fig. \ref{nuvrelphotmcat} use the per-visit MCAT background. Both methods show agreement within 10\% flux on average, with higher dispersion for dimmer sources. The MCAT background method has a more symmetric distribution overall, especially for dimmer sources, which is consistent with the background result in Section \ref{bgcorr}.
...
\caption{Comparison of gPhoton FUV fluxes for LDS749B to the catalog reference value of 15.6 AB Mag (solid line) as a function of exposure depth. The aperture had a radius of 90'' and backgrounds estimated from the MCAT. The error bars on the points denote 1$\sigma$ as reported by gAperture. The dashed lines denote theoretically predicted 3$\sigma$ scatter as predicted from counting statistics; 61\% of the FUV data lie within 3$\sigma$.
\label{ldsabsphotfuv}}
\end{figure*}

\begin{figure*}
\includegraphics[scale=0.7]{LDS749B_90as_ABMag_NUV.pdf}
\caption{Comparison of gPhoton NUV fluxes for LDS749B to the catalog reference value of 14.76 AB Mag (solid line) as a function of exposure depth. The aperture had a radius of 90'' and backgrounds estimated from the MCAT. The error bars on the points denote 1$\sigma$ as reported by gAperture. The dashed lines denote theoretically predicted 3$\sigma$ scatter as predicted from counting statistics; 31\% of the NUV data lie within 3$\sigma$.
\label{ldsabsphotnuv}}
\end{figure*}
...
\caption{Comparison of MCAT FUV fluxes for LDS749B to the catalog reference value of 15.6 AB Mag (solid line) as a function of exposure depth. The aperture had a radius of 90'' and backgrounds estimates were drawn from the visit-level MCAT. The error bars on the points denote 1$\sigma$ as reported by the MCAT. The dashed lines denote ideal 3$\sigma$ scatter as predicted from counting statistics; 86\% of the FUV data lie within 3$\sigma$.
\label{ldsabsphotfuvmcat}}
\end{figure*}

\begin{figure*}
\includegraphics[scale=0.7]{LDS749B_90as_ABMag_NUV_MCAT.pdf}
\caption{Comparison of MCAT NUV fluxes for LDS749B to the catalog reference value of 14.76 AB Mag (solid line) as a function of exposure depth. The aperture had a radius of 90'' and background estimates drawn from the visit-level MCAT. The error bars on the points denote 1$\sigma$ as reported by the MCAT. The dashed lines denote ideal 3$\sigma$ scatter as predicted from counting statistics; 39\% of the NUV data lie within 3$\sigma$.
