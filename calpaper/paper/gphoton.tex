...
\begin{figure}
\includegraphics[scale=0.35]{LDS749B_ABMag_FUV.eps}
\caption{Comparison of gPhoton FUV fluxes for LDS749B to the catalog reference value of 15.57 AB Mag (solid black line) as a function of exposure depth. Background were estimated by means of an unmasked annulus. The dashed lines denote ideal 3 sigma scatter as predicted from counting statistics.
\label{ldsabsphot}}
\end{figure}

\begin{figure}
\includegraphics[scale=0.35]{LDS749B_ABMag_NUV.eps}
\caption{Comparison of gPhoton NUV fluxes for LDS749B to the catalog reference value of 14.71 AB Mag (solid black line) as a function of exposure depth. Background were estimated by means of an unmasked annulus. The dashed lines denote ideal 3 sigma scatter as predicted from counting statistics. \label{ldsabsphot}}
\end{figure}
